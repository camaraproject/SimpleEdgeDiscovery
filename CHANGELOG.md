...
## What's Changed
* fixed: reset version to wip by @Kevsy in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/138
* [bulk] Sync Release Information section (2025-12-02-002) by @hdamker-bot in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/140
* [bulk] Add release-plan.yaml (2026-02-23-001) by @hdamker-bot in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/142
* Update MAINTAINERS.MD by @JoseMConde in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/144
* Update CODEOWNERS by @JoseMConde in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/143
* chore: Update org names in MAINTAINERS.MD by @Kevsy in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/146
* chore: update release plan for Sync26 by @Kevsy in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/148
* [bulk] Enable release automation and validation by @camara-release-automation[bot] in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/151
* Target r2.3 maintenance release (simple-edge-discovery 2.0.1) by @hdamker in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/153
...
## New Contributors
* @camara-release-automation[bot] made their first contribution in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/151
