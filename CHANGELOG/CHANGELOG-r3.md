...
## What's Changed
* Release Automation: Post-release sync (r3.1) by @camara-release-automation[bot] in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/197
* Update release tags for Sync26 rc.2 by @Kevsy in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/204
* Sync common files from Commonalities r4.4 by @camara-release-automation[bot] in https://github.com/camaraproject/SimpleEdgeDiscovery/pull/207
