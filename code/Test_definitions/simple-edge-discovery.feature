Feature: CAMARA Simple Edge Discovery API, v2.1.0-rc.3 - Operation readClosestEdgeCloudZone

  Background:
    Given an environment at "apiRoot"
    And the resource "/simple-edge-discovery/v2rc3/retrieve-closest-edge-cloud-zone"                                                |
